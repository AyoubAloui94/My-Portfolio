    ...
    <div className="bg-[#261B1D] px-7 py-8 text-gray-50 rounded-md">
      <div className="grid grid-cols-1 md:grid-cols-[3fr,1fr] gap-6 md:gap-2">
        ...
        <div className="flex flex-col flex-1  md:justify-center  ">
          <img src="imgs/photo-1.jpg" className="max-h-80 object-cover aspect-square md:w-full h-full rounded-md" loading="lazy" alt="photo-1" />
        </div>
        <div className="flex flex-col flex-1  md:justify-center">
          <img src="imgs/photo-2.jpg" className="max-h-80 md:max-w-80 aspect-square object-cover rounded-md" loading="lazy" alt="photo-2" />
        </div>
      </div>
    </div>
  )
