  ...
  return (
    <>
      ...
      <div className="flex flex-col py-6 px-8 items-center gap-4 text-justify">
        ...
        <p>Towards the end of 2019, 2 friends of mine came up with the idea of starting an E-commerce business. A web developer was needed so I stepped in to fill that role. We made a website on Shopify. Picked a stock theme, dragged and dropped things into place, used extensions and add-ons whenever anything was needed, nothing fancy and no code lines were written that day. And then we realized that the site was pretty laggy and the performance score I believe was out of 100. And all the subscription based apps were starting to make that monthly bill look horrendous.</p>
        <p>After a little bit of googling and common sense, I realized that some apps needed to go but their functionality needed to stay, and at the time Covid lockdowns became a thing so I had more free time on my hands and that was the point where my Web development journey began. I started slowly replacing Shopify apps one by one by code I wrote myself and our website&lsquo;s performance score started to improve, and so did the monthly bills from Shopify. The process took endless nights of research, Stackoverflow and swearing at my keyboard wondering if I was even fit to be the Web Dev for the job, but everytime I was able to figure out a solution and implement it successfully, it made it all worth it and my confidence in my skills grew astronomically, until the next problem I tackled that is..</p>
