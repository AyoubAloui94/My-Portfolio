    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-24">
      ...
      <div className="flex flex-col gap-4 basis-1/2">
        ...
        <div className="flex gap-4 justify-center items-center">
          <Link className="bg-[#4f46e5] hover:bg-[#6159f7] transition duration-300 text-gray-100 w-28 py-2 text-sm font-bold rounded-xl text-center" to={website} target="_blank" rel="noopener noreferrer">
            View App
          </Link>
          <Link className="bg-[#4f46e5] hover:bg-[#6159f7] transition duration-300 text-gray-100 w-28 py-2 text-sm font-bold   rounded-xl text-center" to={repoUrl} target="_blank" rel="noopener noreferrer">
            Github Repo
          </Link>
        </div>
      </div>
